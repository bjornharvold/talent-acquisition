 ...
 */
public class OSCacheStatisticListener implements CacheMapAccessEventListener, CacheEntryEventListener, ScopeEventListener {

    private final static Logger log = LoggerFactory.getLogger(OSCacheStatisticListener.class);
     ...
     */
    public OSCacheStatisticListener() {
        //log.info("OSCache statistics initialized");
    }
    ...
    public String toString() {
        return "OSCacheStatisticListener: Hit = " + hitCount + " / " + hitCountSum
