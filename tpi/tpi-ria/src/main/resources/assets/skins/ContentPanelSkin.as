 ...
 */ 
public class ContentPanelSkin extends HaloBorder
{ 
     ...
     *  Constructor
     */
    public function ContentPanelSkin()
    {
        super();
    }
    ...
    override mx_internal function drawBorder(w:Number, h:Number):void
    {
        ...
        {       
            ...
            var contentBorderAlpha:Number = getStyle("contentBorderAlpha");
            var contentBorderColor:Number = getStyle("contentBorderColor");
            var contentBorderThickness:Number = getStyle("contentBorderThickness");
            ...
            drawDropShadow(0, oldHeaderHeight, w, h - oldHeaderHeight, radius, radius, br, br);
            ...
            if (parentContainer)
            {
                ...
                if (backgroundHole.w > 0 && backgroundHole.h > 0)
                {
                    ...
                    //this will be border
                    g.beginFill(contentBorderColor, contentBorderAlpha);
                    ...
                    g.drawRect(backgroundHole.x + contentBorderThickness, backgroundHole.y + contentBorderThickness, 
                            backgroundHole.w - 2*contentBorderThickness, backgroundHole.h - 2*contentBorderThickness);
                    g.endFill();
