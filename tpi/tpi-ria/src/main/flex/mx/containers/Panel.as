...
/**
 * 
 * This is a near exact copy of Panel.as from Adobe.
 * I have made leftOffset and rightOffset publicly available 
 * so that the title text can be made to rest flush to the left
 * if so desired
 */
 ...
 */
[Style(name="contentBorderAlpha", type="Number", inherit="no")]


[Style(name="contentBorderColor", type="uint", format="Color", inherit="no")]
 ...
 *  @default NaN
 */
[Style(name="contentBorderThickness", type="Number", format="Length", inherit="no")]
...
//    include "../core/Version.as";
	...
	public var leftOffset:Number = 10;
    public var rightOffset:Number = 10;
